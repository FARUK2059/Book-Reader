...
const ListedBooks = () => {
    ...
    // const shortList = useLoaderData();
    // // console.log(shortList);
    // useEffect (() => {
    //     const shortBook = getBookData();
    //     if (shortList.length > 0) {
    //         const shortBy = shortList.filter(short => shortBook.includes(short.bookId))
    //         // console.log(shortBy);
    //         setShortBy(shortBy);
    //         setDisplayShort(shortBy);
    //     }
    // }, [shortList])
